...
version = "v.0.0.56"
FindNumGU = "*"
# BaseFrom1C = 'Y:/Управление Аккредитации/Программа/PortalFSA/DB/BaseFrom1C.db'
# BaseFrom1C = '/Portal/UseFile/BaseFrom1C.db'
GUFolders = "Z:/Управление Аккредитации/Программа/PortalFSA/UI/login.ui"
if os.path.exists(GUFolders):
    ZY = "Z"
else:
    ZY = "Y"
connection = sqlite3.connect(ZY + ":/Управление Аккредитации/Программа/PortalFSA/DB/DinamicBaseNew.db")
...
class LoadScreen(QWidget, threading.Thread):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/Loading.ui", self)
        ...
        try:
            ...
            self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/XOsX.gif")
...
class LoginScreen(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/login.ui", self)
        self.resize(500, 400)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/IconP.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        widget.setWindowIcon(icon)

        conn = sqlite3.connect(ZY + ":/Управление Аккредитации/Программа/PortalFSA/DB/shop_data.db")
        cur = conn.cursor()
    ...
    def DownloadUpdate(self):  # Проверить и создать папку
        GUFolder = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Актуальная версия Программы"
            ...
            if result_PatchNoteRes is None or result_PatchNoteRes == "No" or result_PatchNoteRes == "":
                ...
                if result_pass == password:
                    ...
                    if DownloadDB[0] != "Обновил":
                        shutil.copy(ZY + r':/Управление Аккредитации/Программа/PortalFSA/DB/BaseFrom1C.db',
                                    r'C:/Portal/UseFile/BaseFrom1C.db')
                    FindSettings = shutil.which(r'C:/Portal/UseFile/Settings.db')
                    if FindSettings == None:
                        shutil.copy(ZY + r':/Управление Аккредитации/Программа/PortalFSA/DB/Settings.db',
                                    r'C:/Portal/UseFile/Settings.db')

                    FindArrow = shutil.which(r'C:/Portal/UseFile/Pictures/25623.png')
                    if FindArrow == None:
                        shutil.copy(ZY + r':/Управление Аккредитации/Программа/PortalFSA/Pictures/25623.png',
                                    r'C:/Portal/UseFile/Pictures/25623.png')

                    FindGus = shutil.which(r'C:/Portal/UseFile/Pictures/XOsX.gif')
                    if FindGus == None:
                        shutil.copy(ZY + r':/Управление Аккредитации/Программа/PortalFSA/Pictures/XOsX.gif',
...
class Loading(QWidget, threading.Thread):
    def __init__(self):
        ...
        # self.setAttribute(Qt.WA_TranslucentBackground, True)
        self.setWindowFlags(Qt.WindowStaysOnTopHint | Qt.CustomizeWindowHint)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/Loading2.ui", self)
...
class CreateAccScreen(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/createacc.ui", self)
...
class FillProfileScreen(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/fillprofile.ui", self)
...
class CreateAlarm(QDialog):
    def __init__(self):
        ...
        self.setWindowFlags(Qt.WindowStaysOnTopHint | Qt.CustomizeWindowHint)
        #self.setAttribute(Qt.WA_TranslucentBackground, True)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/Alarm.ui", self)
        self.MsgErrorText.setText(MsgError)
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/Darg1.gif")
        self.ErrorDrag1.setMovie(self.movie)
        self.movie.start()
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/Darg2.gif")
...
class CreateWhat(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/ExcelDownload.ui", self)
    ...
    def NewPortalExl(self):
        try:
            ...
            datenow = str(datenow)
            i = 1
            VigFile = ZY + ':/Управление Аккредитации/Программа/PortalFSA/Выгрузки/' + datenow
    ...
    def OldPortalExl(self):
        try:
            ...
            if os.path.exists(VigFile):
                ...
                os.mkdir(VigFile)
            connection = sqlite3.connect(ZY + ':/Управление Аккредитации/Программа/PortalFSA/DB/PortalKu.db')
            # reo = connection.cursor()
...
class CreateGroup1GU(QDialog):
    ...
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/Group1GU.ui", self)
        ...
        GUFolder = ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU
        if os.path.exists(GUFolder):
            What = "Папка уже создана"
        else:
            os.mkdir(GUFolder)
        dirPath = ZY + r":\Управление Аккредитации\Программа\PortalFSA\ГУ\1 Группа" + r"\""
...
# Создание Word по 3 группе
    def CreatePricaz3GR(self):
        ...
        if TipGU_VO_DO == "ПК1" or TipGU_VO_DO == "ПК2" or TipGU_VO_DO == "ПК5":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Приказ/1. ПК (положительный).docx"
        elif TipGU_VO_DO == "ПК1+РОА" or TipGU_VO_DO == "ПК2+РОА" or TipGU_VO_DO == "ПК5+РОА":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Приказ/1. ПК+РОА (положительный).docx"
        elif TipGU_VO_DO == "ПК1+РОА+ИМОД" or TipGU_VO_DO == "ПК2+РОА+ИМОД" or TipGU_VO_DO == "ПК5+РОА+ИМОД":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Приказ/1. ПК+РОА+ИМОД (положительный).docx"
        elif TipGU_VO_DO == "РОА":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Приказ/1. РОА (положительный).docx"
        elif TipGU_VO_DO == "АК":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Приказ/1. АК (положительный).docx"
        else:
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Приказ/1. ПК+ИМОД (положительный).docx"
        ...
        try:
            doc.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/5. Итог Приказ " + TipGU_VO_DO + " " + FullGU + ".docx")
            os.startfile(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/5. Итог Приказ " + TipGU_VO_DO + " " + FullGU + ".docx")
        except:
    ...
    def CreateSzPolojGroup3(self):
        ...
        if TipGU_VO_DO != "АК" and TipGU_VO_DO != "РОА":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/СЗ/1. СЗ ПК (положительный).docx"
        elif TipGU_VO_DO == "РОА":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/СЗ/1. СЗ РОА (положительный).docx"
        elif TipGU_VO_DO == "АК":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/СЗ/1. СЗ АК (положительный).docx"
        ...
        try:
            doc.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/4. СЗ Итог " + TipGU_VO_DO + " " + FullGU + ".docx")
            os.startfile(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/4. СЗ Итог " + TipGU_VO_DO + " " + FullGU + ".docx")
        except:
            print("Ошибка при создании уведомления")
    def CreateSoprPolojGroup3(self):
        ...
        if TipGU_VO_DO == "АК":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Уведомление/1. Сопровод АК (положительный).docx"
        elif TipGU_VO_DO == "РОА" or TipGU_VO_DO == "РОА+ИМОД":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Уведомление/1. Сопровод РОА (положительный).docx"
        else:
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group3/ОЕИ/Уведомление/1. Сопровод ПК (положительный).docx"
        ...
        try:
            doc.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/6. Сопроводительной письмо Итог " + FullGU + ".docx")
            os.startfile(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/6. Сопроводительной письмо Итог " + FullGU + ".docx")
        except:
            print("Ошибка при создании уведомления")
...
# Создание Word по 2 группе
    def CreatePolojGroup2(self):
        ...
        if TipGU_VO_DO == "АК" and ItogVivod == "Полож.":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group2/Подожительный/Увед. полож. АКК.docx"
        elif (TipGU_VO_DO == "РОА" or TipGU_VO_DO == "РОА+ИМОД") and ItogVivod == "Полож.":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group2/Подожительный/Увед. полож. РОА.docx"
        elif TipGU_VO_DO == "АК" and ItogVivod == "Отриц. не отказ":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group2/ОтрицательныйНе34/Уведомление АКК выезд с перечнем.docx"
        elif (TipGU_VO_DO == "РОА" or TipGU_VO_DO == "РОА+ИМОД") and ItogVivod == "Отриц. не отказ":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group2/ОтрицательныйНе34/Уведомление РОА выезд с перечнем.docx"
        ...
        try:
            doc.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/3. Уведомление по ВО (полож.) " + TipGU_VO_DO + " " + FullGU + ".docx")
            os.startfile(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/3. Уведомление по ВО (полож.) " + TipGU_VO_DO + " " + FullGU + ".docx")
        except:
            print("Ошибка при создании уведомления")
    def CreateSzOtricGroup2(self):
        ...
        if TipGU_VO_DO == "АК":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group2/ОтрицательныйНе34/СЗ АКК выезд с перечнем.docx"
        elif TipGU_VO_DO == "РОА" or TipGU_VO_DO == "РОА+ИМОД":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group2/ОтрицательныйНе34/СЗ РОА выезд с перечнем.docx"
        ...
        try:
            doc.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/4. СЗ по ВО (отриц. не отказ) " + TipGU_VO_DO + " " + FullGU + ".docx")
            os.startfile(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/4. СЗ по ВО (отриц. не отказ) " + TipGU_VO_DO + " " + FullGU + ".docx")
        except:
            print("Ошибка при создании уведомления")
#---------------------------------
    def CreateYvedEG(self):
        ...
        if TipGU_VO_DO == "АК":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/YvedOSostaveEG/2. Уведомление по ЭГ АКК.docx"
        elif TipGU_VO_DO == "РОА" or TipGU_VO_DO == "РОА+ИМОД":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/YvedOSostaveEG/3. Уведомление по ЭГ РОА.docx"
        else:
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/YvedOSostaveEG/1. Уведомление по ЭГ.docx"
        ...
        try:
            doc.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/1. Уведомление по ЭГ " + FullGU + ".docx")
            os.startfile(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/1. Уведомление по ЭГ " + FullGU + ".docx")
        except:
            print("Ошибка при создании уведомления")
    ...
    def SaveALLS(self, result, ):
        try:
            ...
            self.SaveGif.show()
            self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/well-done.gif")
    ...
    def Create_Pricaz_1Group(self):  # Создание приказ 1 группа
        ...
        if ObshObl == "ИЛ":
            ...
            if TipGU_VO_DO == "АК":
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/"
            ...
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по поверке средств измерений"
            if TipGU_VO_DO == "АК":
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ПСИ (АК).docx")
            else:
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ПСИ.docx")
            ...
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по калибровке средств измерений"
            if TipGU_VO_DO == "АК":
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/КСИ (АК).docx")
            else:
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/КСИ.docx")
            ...
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по испытанию средств измерений в целях утверждения типа"
            doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ИСИ.docx")
            ...
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по испытанию стандартных образцов в целях утверждения типа"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ИСО.docx")  # Ещё нет!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по аттестации методик (методов) измерений"
            if TipGU_VO_DO == "АК":
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/АМ (АК).docx")
            else:
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/АМ.docx")
            ...
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по метрологической экспертизе"
            doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/МЭ.docx")
            shema = "со схемой аккредитации юридических лиц и индивидуальных предпринимателей, выполняющих работы и (или) оказывающих услуги по аттестации методик (методов) измерений и (или) метрологической экспертизе, в национальной системе аккредитации 01.03.2022 (СМ № 03.1-9.0018)"
        elif ObshObl == "Метрология" and Obl == "АМ и МЭ":
            accObl = "в области обеспечения единства измерений для выполнения работ и (или) оказания услуг по аттестации методик (методов) измерений и метрологической экспертизе"
            if TipGU_VO_DO == "АК":
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/АМ МЭ (АК).docx")
            else:
                doc2 = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/АМ МЭ.docx")
            shema = "со схемой аккредитации юридических лиц и индивидуальных предпринимателей, выполняющих работы и (или) оказывающих услуги по аттестации методик (методов) измерений и (или) метрологической экспертизе, в национальной системе аккредитации 01.03.2022 (СМ № 03.1-9.0018)"
        elif ObshObl == "Метрология" and Obl == "17020":
            accObl = "в качестве органа инспекции"
            acc = "(орган инспекции)"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ОИ 17020.docx")  # Ещё нет!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            shema = "со схемой аккредитации органов инспекций в национальной системе аккредитации 11.03.2022 (СМ № 03.1-9.0011)"
        elif ObshObl == "Метрология" and Obl == "17021":
            accObl = "в качестве органа по сертификации систем менеджмента"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ОС 17021 СМК 9000.docx")  # ХЗ как выбирать (надо спросить)!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ОС 17021 СМК 22000.docx")  # ХЗ как выбирать (надо спросить)!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            accObl = "в качестве органа по сертификации персонала"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ОС 17024.docx")
        elif ObshObl == "Метрология" and Obl == "17043":
            accObl = "в качестве провайдера межлабораторных сличительных испытаний"  # Не уверен
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/МСИ 17043.docx")
            ...
            accObl = "в качестве органа по сертификации продукции, услуг"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ОС 17065.docx")
            ...
            accObl = "в качестве испытательной лаборатории"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/15189.docx")  # Ещё нет!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            ...
            accObl = "в качестве органа по валидации и верификации парниковых газов"
            doc2 = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/14065.docx")  # Ещё нет!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        ...
        if TipGU_VO_DO == "АК":
            master = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Pricaz/2. Приказ АК или РОА.docx")
        elif TipGU_VO_DO == "РОА":
            master = Document(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Pricaz/2. Приказ АК или РОА.docx")
        else:
            master = Document(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Pricaz/1. Приказ.docx")
        ...
        if VO_DO == "ДО" and TipGU_VO_DO != "АК" and TipGU_VO_DO != "РОА":
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Pricaz/1. Приказ.docx"
            doc = DocxTemplate(path)
            next_str = ""
        else:
            composer.append(doc2)
            composer.save(
                ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/2. Приказ " + Obl + " " + FullGU + " " + VO_DO +".docx")
            #############
            path = ZY + ":/Управление Аккредитации/Программа/PortalFSA/ГУ/1 Группа/" + FullGU + "/2. Приказ " + Obl + " " + FullGU + " " + VO_DO +".docx"
            doc = DocxTemplate(path)
            next_str = "\f"

        # sd = DocxTemplate(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Group1/Programma_OEI/ПСИ.docx")
        self.FixFullNaimKogo()  # испраить ООО на падеж
        FullGU = self.NomerGU.toPlainText()
        FullGUSplit = FullGU.split()
        DataPricaza = FullGUSplit[2]
...
class PatchNote(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/PatchNote.ui", self)
...
class CreateUpdate(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/Updater.ui", self)

        self.FIndFile.clicked.connect(self.getfile)
        self.Update.clicked.connect(self.DoUpdate)
        self.Update.setEnabled(False)

        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/peach-cat.gif")
        self.ErrorDrag1.setMovie(self.movie)
        self.movie.start()
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/mochi-cat-chibi-cat.gif")
        self.ErrorDrag2.setMovie(self.movie)
        self.movie.start()
    ...
    def DoUpdate(self):
        ...
        df = pd.DataFrame(pd.read_excel(ZY + ':/Управление Аккредитации/Программа/PortalFSA/DB Excel/xlsx/Список.xlsx'))

        connection = sqlite3.connect(ZY + ':/Управление Аккредитации/Программа/PortalFSA/DB/BaseFrom1C.db')
...
class CreateAleshaChoise(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/AleshaChoise.ui", self)
        ...
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/parrot.gif")
        self.AleshaGif1.setMovie(self.movie)
        self.movie.start()
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/car.gif")
    ...
    def AleshaToExcel(self):
        ...
        try:
            if AleshaWho == "Предложения":
                VigFile = ZY + ':/Управление Аккредитации/Программа/PortalFSA/Выгрузки/Просрочки по Предложениям'
            elif AleshaWho == "Договор":
                VigFile = ZY + ':/Управление Аккредитации/Программа/PortalFSA/Выгрузки/Просрочки по Договору'
            if os.path.exists(VigFile):
                What = "Папка уже создана"
            else:
                os.mkdir(VigFile)
...
class CreateAleshaPredl(QDialog):
    def __init__(self):
        ...
        cal.holidays(2022)
        pd.set_option("display.max_rows", None, "display.max_columns", None)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/AleshaPredl.ui", self)
        ...
        conn = sqlite3.connect(ZY + ':/Управление Аккредитации/Программа/PortalFSA/DB/DinamicBaseNew.db')
        cursor = conn.cursor()
        cursor.execute(
        ...
        for i in range(LongDF):
            ...
            if Tip != "ПСИ":
                mail.HTMLBody = '<p>Добрый день, Вам назначена государственная услуга ' + FullGU + '.</p>' \
                                ...
                                '<p><strong><img src="' + ZY + ':\Управление Аккредитации\Программа\PortalFSA\Pictures\logo2.jpg" width="240" height="100" alt="" /></strong></p>'
            else:
                mail.HTMLBody = '<p>Добрый день, Вам назначена государственная услуга ' + FullGU + '.</p>' \
                                '<p>Обращаем Ваше внимание, что в соответствии с пунктом 11 Порядка формирования экспертной ' \
                                'группы, утверждённого приказом Минэкономразвития России от 29.10.2021 № 657, установлено, ' \
...
class CreateAleshaDogovor(QDialog):
    def __init__(self):
        ...
        cal.holidays(2022)
        pd.set_option("display.max_rows", None, "display.max_columns", None)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/AleshaDogovor.ui", self)
    ...
    def AleshaMailDogovorZav18(self):
        ...
        for i in range(LongDF):
            ...
            mail.HTMLBody = '<p>Добрый день.</p><p>Пунктом 31 Правил осуществления аккредитации в национальной системе аккредитации, ' \
                            ...
                            '</o:p><sub></sub></p><p><strong><img src="' + ZY + ':\Управление Аккредитации\Программа\PortalFSA\Pictures\logo2.jpg" width="240" height="100" alt="" /></strong></p>'
...
class CreateAleshaEZ(QDialog):
    def __init__(self):
        ...
        cal.holidays(2022)
        pd.set_option("display.max_rows", None, "display.max_columns", None)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/AleshaEZ.ui", self)
        self.AleshaTable.setColumnCount(8)
        self.AleshaTable.setColumnWidth(0, 50)
        self.AleshaTable.setColumnWidth(1, 70)
        self.AleshaTable.setColumnWidth(2, 70)
...
class CreateAleshaAct(QDialog):
    def __init__(self):
        ...
        cal.holidays(2022)
        pd.set_option("display.max_rows", None, "display.max_columns", None)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/AleshaAct.ui", self)
        self.AleshaTable.setColumnCount(8)
        self.AleshaTable.setColumnWidth(0, 50)
        self.AleshaTable.setColumnWidth(1, 70)
        self.AleshaTable.setColumnWidth(2, 70)
...
class SendMailRass(QDialog):
    def __init__(self):
        ...
        self.setWindowFlags(Qt.WindowStaysOnTopHint | Qt.CustomizeWindowHint)
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/Mailer.ui", self)

        self.CopySpisok.clicked.connect(self.CopyToTable)


    def CopyToTable(self):
        Spisok = load_workbook(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Shablon/Список рассылки/Список рассылки.xlsx")
        c = Spisok['Лист1']
...
class MainWindow(QDialog):
    def __init__(self):
        ...
        loadUi(ZY + ":/Управление Аккредитации/Программа/PortalFSA/UI/mainForm.ui", self)
        ...
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/Book.gif")
        self.Book.setMovie(self.movie)
        self.movie.start()
        self.Book_button.clicked.connect(self.OpenBook)
        #self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/lady-noir.gif")
        ...
        #self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/giphy.gif")
        #self.Download_Excel.setMovie(self.movie)
        #self.movie.start()
        self.Download_Excel_button.clicked.connect(self.gotoWhat)
        #self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/sharingan-item.gif")
        #self.Portal_Ku_l.setMovie(self.movie)
        #self.movie.start()
        self.Portal_Ku_b.clicked.connect(self.DoPortalKu)
        #self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/Mailer.gif")
        #self.Mailer_l.setMovie(self.movie)
        #self.movie.start()
        #self.Mailer_b.clicked.connect(self.DoPortalKu)
        #self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/DashIcon.gif")
        ...
        connection777 = sqlite3.connect(ZY + ":/Управление Аккредитации/Программа/PortalFSA/DB/shop_data.db")
...
############################################
    ...
    def OpenBook(self):
        GUFolder = ZY + ":/Управление Аккредитации/Программа/PortalFSA/Book"
        if os.path.exists(GUFolder):
            os.startfile(GUFolder)
        else:
            # os.mkdir(GUFolder)
    ...
    def loaddata(self):
        ...
        global TipDop
        global UPR
        connection = sqlite3.connect(ZY + ":/Управление Аккредитации/Программа/PortalFSA/DB/shop_data.db")
    ...
    def Loading2(self):
        self.movie = QMovie(ZY + ":/Управление Аккредитации/Программа/PortalFSA/Pictures/Gear.gif")
 ...
 # Запрос в sql на кол-ва ячеек в базе данных || AND (ДатаприказаосоставеЭГ is NULL OR ДатаприказаосоставеЭГ = 'Не зарегистрирован')||
            ...
            for i in range(sqllong2):  # sqllong2 = все ГУ
                ...
                # pushButton.setStyleSheet("border-image: url('Y:/Управление Аккредитации/Программа/PortalFSA/Pictures/migrate.png')") # Картинка в кнопке
